...
with agents_client:
    ...
    # Create connected agent tools for the support agents so they can be used by other agents.
    ...
    triage_agent = agents_client.create_agent(
        ...
        # tools=[...] gives the agent access to three connected agents as tools.
        tools=[
